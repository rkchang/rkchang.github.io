...
\usepackage[top=0.2in, bottom=1in, left=0.5in, right=0.5in]{geometry} \setcounter{secnumdepth}{0}
...
\begin{center}
    ...
    \faIcon{linkedin} \href{https://linkedin.com/in/rkhchang}{linkedin.com/in/rkhchang} \space\space
